...
/// This class accepts the master Astrix XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in Astrix master private keys use `kprv` prefix.
///
