...
use astrix_addresses::AddressOrStringArrayT;
use astrix_consensus_client::UtxoEntryReferenceArrayT;
...
/// on the Astrix network.  When an address is registered with UtxoContext
