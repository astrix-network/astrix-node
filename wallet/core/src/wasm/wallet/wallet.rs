...
use astrix_wallet_macros::declare_typescript_wasm_interface as declare;
use astrix_wasm_core::events::{get_event_targets, Sink};
use astrix_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Astrix Node is developed in Rust, and the Wallet class is a Rust implementation
