...
use astrix_notify::events::EVENT_TYPE_ARRAY;
use astrix_notify::listener::{ListenerId, ListenerLifespan};
use astrix_notify::notifier::{Notifier, Notify};
use astrix_notify::scope::Scope;
...
use astrix_rpc_core::api::ctl::RpcCtl;
use astrix_rpc_core::{api::rpc::RpcApi, *};
use astrix_rpc_core::{notify::connection::ChannelConnection, RpcResult};
use std::sync::Arc;
...
impl RpcCoreMock {
    ...
    #[allow(dead_code)]
    pub fn notify_new_block_template(&self) -> astrix_notify::error::Result<()> {
