...
use astrix_bip32::Error as BIP32Error;
use astrix_consensus_core::sign::Error as CoreSignError;
use astrix_rpc_core::RpcError as AstrixRpcError;
use astrix_wrpc_client::error::Error as AstrixWorkflowRpcError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WalletKeys(#[from] astrix_wallet_keys::error::Error),

    #[error("please select an account")]
    AccountSelection,

    #[error("{0}")]
    AstrixRpcClientResult(#[from] AstrixRpcError),

    #[error("wRPC -> {0}")]
    RpcError(#[from] RpcError),

    #[error("Wallet wRPC -> {0}")]
    AstrixWorkflowRpcError(#[from] AstrixWorkflowRpcError),
    ...
    #[error("{0}")]
    NetworkType(#[from] astrix_consensus_core::network::NetworkTypeError),

    #[error("{0}")]
    NetworkId(#[from] astrix_consensus_core::network::NetworkIdError),
    ...
    #[error(transparent)]
    Address(#[from] astrix_addresses::AddressError),
    ...
    #[error(transparent)]
    ScriptBuilderError(#[from] astrix_txscript::script_builder::ScriptBuilderError),
    ...
    #[error(transparent)]
    ConsensusClient(#[from] astrix_consensus_client::error::Error),

    #[error(transparent)]
    ConsensusWasm(#[from] astrix_consensus_wasm::error::Error),
    ...
    #[error(transparent)]
    MultisigCreateError(#[from] astrix_txscript::MultisigCreateError),

    #[error(transparent)]
    TxScriptError(#[from] astrix_txscript_errors::TxScriptError),
    ...
    #[error(transparent)]
    Metrics(#[from] astrix_metrics_core::error::Error),
}
