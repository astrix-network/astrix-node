...
use astrix_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] astrix_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] astrix_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] astrix_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] astrix_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(astrix_metrics_core::error::Error),

    #[error(transparent)]
    AstrixWalletKeys(#[from] astrix_wallet_keys::error::Error),
}
