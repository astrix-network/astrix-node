use crate::cli::AstrixCli;
use crate::imports::*;
use crate::result::Result;
use astrix_bip32::{Language, Mnemonic, WordCount};
use astrix_wallet_core::account::MULTISIG_ACCOUNT_KIND;
// use astrix_wallet_core::runtime::wallet::AccountCreateArgsBip32;
// use astrix_wallet_core::runtime::{PrvKeyDataArgs, PrvKeyDataCreateArgs};
// use astrix_wallet_core::storage::AccountKind;
...
async fn create_multisig(ctx: &Arc<AstrixCli>, account_name: Option<String>, mnemonic_phrase_word_count: WordCount) -> Result<()> {
    let term = ctx.term();
    let wallet = ctx.wallet();
