...
const astrix = require('../astrix/astrix_wasm');
...
astrix.init_console_panic_hook();
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"astrix:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "astrixtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("astrixtest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new astrix.TransactionOutput(300n, new astrix.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new astrix.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
