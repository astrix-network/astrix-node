...
(async () => {
    ...
    console.info(`Full astrix address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Astrix
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : astrixToSompi(0.2)}],
            priorityFee: astrixToSompi(0.0001),
