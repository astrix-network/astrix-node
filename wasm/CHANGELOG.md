Latest online documentation available at: https://astrix.aspectron.org/docs/
### Release 2024-04-27
...
- Merge with Astrix Node master (0.13.6)
...
- Rename `astrix-beacon` app to `astrix-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `astrix-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://astrix.aspectron.org/docs/
