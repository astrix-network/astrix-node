...
use astrix_addressmanager::{AddressManager, NetAddress};
use astrix_core::{debug, info, warn};
use astrix_p2p_lib::{common::ProtocolError, ConnectionError, Peer};
...
pub struct ConnectionManager {
    p2p_adaptor: Arc<astrix_p2p_lib::Adaptor>,
...
impl ConnectionManager {
    ...
    async fn handle_outbound_connections(self: &Arc<Self>, peer_by_address: &HashMap<SocketAddr, Peer>) {
        let active_outbound: HashSet<astrix_addressmanager::NetAddress> =
