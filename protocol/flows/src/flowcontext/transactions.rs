...
use astrix_p2p_lib::{
    make_message,
    pb::{astrixd_message::Payload, InvTransactionsMessage, AstrixdMessage},
    Hub,
};
...
impl TransactionsSpread {
    ...
    /// capacity.
    ///
    /// _GO-ASTRIXD: EnqueueTransactionIDsForPropagation_
    ...
    async fn broadcast(&self, msg: AstrixdMessage, should_throttle: bool) {
        if should_throttle {
