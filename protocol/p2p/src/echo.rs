use crate::{
    ...
    handshake::AstrixdHandshake,
    pb::{self, VersionMessage},
    IncomingRoute, AstrixdMessagePayloadType, Router,
};
use astrix_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            AstrixdMessagePayloadType::Addresses,
            AstrixdMessagePayloadType::Block,
            AstrixdMessagePayloadType::Transaction,
            AstrixdMessagePayloadType::BlockLocator,
            AstrixdMessagePayloadType::RequestAddresses,
            AstrixdMessagePayloadType::RequestRelayBlocks,
            AstrixdMessagePayloadType::RequestTransactions,
            AstrixdMessagePayloadType::IbdBlock,
            AstrixdMessagePayloadType::InvRelayBlock,
            AstrixdMessagePayloadType::InvTransactions,
            AstrixdMessagePayloadType::Ping,
            AstrixdMessagePayloadType::Pong,
            // AstrixdMessagePayloadType::Verack,
            // AstrixdMessagePayloadType::Version,
            // AstrixdMessagePayloadType::Ready,
            AstrixdMessagePayloadType::TransactionNotFound,
            AstrixdMessagePayloadType::Reject,
            AstrixdMessagePayloadType::PruningPointUtxoSetChunk,
            AstrixdMessagePayloadType::RequestIbdBlocks,
            ...
            AstrixdMessagePayloadType::RequestNextHeaders,
            AstrixdMessagePayloadType::DoneHeaders,
            AstrixdMessagePayloadType::RequestPruningPointUtxoSet,
            AstrixdMessagePayloadType::RequestHeaders,
            AstrixdMessagePayloadType::RequestBlockLocator,
            AstrixdMessagePayloadType::PruningPoints,
            AstrixdMessagePayloadType::RequestPruningPointProof,
            ...
            AstrixdMessagePayloadType::RequestIbdChainBlockLocator,
            AstrixdMessagePayloadType::IbdChainBlockLocator,
            AstrixdMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::AstrixdMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "astrix-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate astrix P2P handshaking
        //

        // Build the handshake object and subscribe to handshake messages
        let mut handshake = AstrixdHandshake::new(&router);
...
mod tests {
    ...
    use astrix_utils::networking::NetAddress;

    #[tokio::test]
    async fn test_handshake() {
        astrix_core::log::try_init_logger("debug");
