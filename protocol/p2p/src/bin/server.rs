...
use astrix_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    astrix_core::log::init_logger(None, "debug");
    ...
    let adaptor = astrix_p2p_lib::Adaptor::bidirectional(ip_port, astrix_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
    // [1] - connect to a few peers
    let ip_port = String::from("[::1]:34551");
    for i in 0..1 {
