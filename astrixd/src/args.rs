...
use astrix_core::astrixd_env::version;
use astrix_notify::address::tracker::Tracker;
use astrix_utils::networking::ContextualNetAddress;
use astrix_wrpc_server::address::WrpcNetAddress;
...
#[cfg(feature = "devnet-prealloc")]
use astrix_consensus_core::tx::{TransactionOutpoint, UtxoEntry};
#[cfg(feature = "devnet-prealloc")]
...
impl Args {
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> astrix_consensus_core::utxo::utxo_collection::UtxoCollection {
...
pub fn cli() -> Command {
    ...
    let cmd = Command::new("astrixd")
        .about(format!("{} (astrix-node) v{}", env!("CARGO_PKG_DESCRIPTION"), version()))
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 34150, testnet: 34250)."),
        )
        .arg(
            Arg::new("rpclisten-borsh")
                ...
                .help("Interface:port to listen for wRPC Borsh connections (default port: 17110, testnet: 35250)."),
        ...
        .arg(
            Arg::new("rpclisten-json")
                ...
                .value_parser(clap::value_parser!(WrpcNetAddress))
                .help("Interface:port to listen for wRPC JSON connections (default port: 36150, testnet: 36250)."),
        )
        ...
        .arg(
            Arg::new("listen")
                ...
                .require_equals(true)
                .value_parser(clap::value_parser!(ContextualNetAddress))
                .help("Add an interface:port to listen for connections (default all interfaces port: 34551, testnet: 34251)."),
        )
        .arg(
            Arg::new("outpeers")
                .long("outpeers")
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --whitelist=                          Add an IP network or IP that will not be banned. (eg. 192.168.1.0/24 or
                                            ::1)
      --rpclisten=                          Add an interface/port to listen for RPC connections (default port: 34150,
                                            testnet: 34250)
      --rpccert=                            File containing the certificate file (default:
                                            /Users/aspect/Library/Application Support/Astrixd/rpc.cert)
      --rpckey=                             File containing the certificate key (default:
                                            /Users/aspect/Library/Application Support/Astrixd/rpc.key)
  ...
  -d, --loglevel=                           Logging level for all subsystems {trace, debug, info, warn, error,
      ...
      --minrelaytxfee=                      The minimum transaction fee in AIX/kB to be considered a non-zero fee.
                                            (default: 1e-05)
