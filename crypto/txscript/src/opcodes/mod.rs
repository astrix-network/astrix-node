...
use astrix_consensus_core::hashing::sighash_type::SigHashType;
use astrix_consensus_core::tx::VerifiableTransaction;
...
opcode_list! {
    ...
    opcode OpIf<0x63, 1>(self, vm) {
        ...
        if vm.is_executing() {
            ...
            // the similar flow of go-astrixd
...
mod test {
    ...
    use astrix_consensus_core::constants::{SOMPI_PER_ASTRIX, TX_VERSION};
    ...
    fn make_mock_transaction(lock_time: u64) -> (VerifiableTransactionMock, TransactionInput, UtxoEntry) {
        let dummy_prev_out = TransactionOutpoint::new(astrix_hashes::Hash::from_u64_word(1), 1);
        ...
        let dummy_tx_out = TransactionOutput::new(SOMPI_PER_ASTRIX, dummy_script_public_key);
