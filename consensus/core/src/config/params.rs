...
pub struct Params {
    ...
    /// The parameter for scaling inverse AIX value to mass units (unpublished KIP-0009)
...
impl Params {
    ...
    /// Based on the analysis at <https://github.com/astrix-network/docs/blob/main/Reference/prunality/Prunality.pdf>
...
pub const MAINNET_PARAMS: Params = Params {
    ...
    // This is technically a soft fork from the Go implementation since astrixd's consensus doesn't
    ...
    deflationary_phase_daa_score: 4,
    pre_deflationary_phase_base_subsidy: 5000000000000000,
