...
use astrix_hashes::{Hash, ZERO_HASH};
use astrix_muhash::EMPTY_MUHASH;
...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0xf0, 0x5c, 0xf1, 0x44, 0xaf, 0x06, 0x7b, 0x20, 0xcf, 0xae, 0x86, 0xb8, 0x97, 0x6d, 0xce, 0x34, 0xfa, 0xc7, 0x2c, 0x41, 0x7c,
        0xcb, 0xdb, 0xd6, 0x56, 0x39, 0x66, 0x37, 0x22, 0xb3, 0x06, 0xf3,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0xfc, 0xe2, 0x3f, 0xe1, 0x8f, 0x13, 0xd3, 0x50, 0xbc, 0x6a, 0x75, 0x44, 0xff, 0xd7, 0x86, 0xd1, 0x50, 0x02, 0x94, 0x83, 0x4d,
        0x94, 0x66, 0x6c,0x4c, 0xa8, 0x89, 0x13, 0x60, 0xbc, 0x2e, 0x53,
    ]),
    utxo_commitment: EMPTY_MUHASH,
    timestamp: 1724083467531,
    bits: 492453022,
    nonce: 953450431,
...
mod tests {
    ...
    fn gen_testnet11_genesis() {
        ...
        let target = astrix_math::Uint256::from_compact_target_bits(genesis.bits);
