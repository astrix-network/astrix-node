...
pub const SOMPI_PER_ASTRIX: u64 = 100_000_000;

/// The parameter for scaling inverse AIX value to mass units (KIP-0009)
pub const STORAGE_MASS_PARAMETER: u64 = SOMPI_PER_ASTRIX * 10_000;

/// MaxSompi is the maximum transaction amount allowed in sompi.
pub const MAX_SOMPI: u64 = 2_262_000_000 * SOMPI_PER_ASTRIX;
