...
impl NetworkType {
    pub fn default_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 34150,
            NetworkType::Testnet => 34250,
            NetworkType::Simnet => 34550,
            NetworkType::Devnet => 34650,
        }
    }

    pub fn default_borsh_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 35150,
            NetworkType::Testnet => 35250,
            NetworkType::Simnet => 35550,
            NetworkType::Devnet => 35650,
        }
    }

    pub fn default_json_rpc_port(&self) -> u16 {
        match self {
            NetworkType::Mainnet => 36150,
            NetworkType::Testnet => 36250,
            NetworkType::Simnet => 36550,
            NetworkType::Devnet => 36650,
        }
    }
...
pub enum NetworkIdError {
    #[error("Invalid network name prefix: {0}. The expected prefix is 'astrix'.")]
...
///
/// NetworkId is a unique identifier for a astrix network instance.
...
impl NetworkId {
    ...
    pub fn default_p2p_port(&self) -> u16 {
        ...
        match self.network_type {
            NetworkType::Mainnet => 34551,
            NetworkType::Testnet => match self.suffix {
                Some(10) => 34251,
                Some(11) => 34351,
                None | Some(_) => 34451,
            },
            NetworkType::Simnet => 34551,
            NetworkType::Devnet => 34651,
        }
    }
    ...
    /// Returns a textual description of the network prefixed with `astrix-`
    pub fn to_prefixed(&self) -> String {
        format!("astrix-{}", self)
    }

    pub fn from_prefixed(prefixed: &str) -> Result<Self, NetworkIdError> {
        if let Some(stripped) = prefixed.strip_prefix("astrix-") {
