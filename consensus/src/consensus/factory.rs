...
use astrix_consensusmanager::{ConsensusFactory, ConsensusInstance, DynConsensusCtl, SessionLock};
use astrix_core::{debug, time::unix_now, warn};
use astrix_database::{
    prelude::{
...
impl ConsensusFactory for Factory {
    fn new_active_consensus(&self) -> (ConsensusInstance, DynConsensusCtl) {
        ...
        let db = astrix_database::prelude::ConnBuilder::default()
            .with_db_path(dir)
