...
use astrix_consensusmanager::SessionLock;
use astrix_core::{debug, info, time::unix_now, trace, warn};
use astrix_database::prelude::{StoreError, StoreResultEmptyTuple, StoreResultExtensions};
use astrix_hashes::Hash;
use astrix_muhash::MuHash;
use astrix_notify::{events::EventType, notifier::Notify};

use crossbeam_channel::{Receiver as CrossbeamReceiver, Sender as CrossbeamSender};
use itertools::Itertools;
use astrix_utils::binary_heap::BinaryHeapExtensions;
...
impl VirtualStateProcessor {
    ...
    pub(crate) fn build_block_template_from_virtual_state(
        ...
        let accepted_id_merkle_root = astrix_merkle::calc_merkle_root(virtual_state.accepted_tx_ids.iter().copied());
