...
use js_sys::BigInt;
use astrix_consensus_client::Header;
use astrix_consensus_core::hashing;
use astrix_hashes::Hash;
use astrix_hashes::PowHash;
...
// https://github.com/tmrlvi/astrix-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L36
const DIFFICULTY_1_TARGET: (u64, i16) = (0xffffu64, 208); // 0xffff 2^208

/// `calculate_difficulty` is based on set_difficulty function: <https://github.com/tmrlvi/astrix-miner/blob/bf361d02a46c580f55f46b5dfa773477634a5753/src/client/stratum.rs#L375>
/// @category PoW
