...
use astrix_consensus_core::network::NetworkTypeT;
use astrix_consensus_core::subnets::{self, SubnetworkId};
use astrix_consensus_core::tx::UtxoEntry;
use astrix_txscript::extract_script_pub_key_address;
use astrix_utils::hex::*;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<astrix_addresses::AddressArrayT> {
