...
use astrix_consensus::consensus::Consensus;
use astrix_consensus::model::stores::virtual_state::VirtualStateStoreReader;
use astrix_consensus::params::Params;
use astrix_consensus::processes::mass::MassCalculator;
use astrix_consensus_core::api::ConsensusApi;
use astrix_consensus_core::block::{Block, TemplateBuildMode, TemplateTransactionSelector};
use astrix_consensus_core::coinbase::MinerData;
use astrix_consensus_core::sign::sign;
use astrix_consensus_core::subnets::SUBNETWORK_ID_NATIVE;
use astrix_consensus_core::tx::{
...
use astrix_consensus_core::utxo::utxo_view::UtxoView;
use astrix_core::trace;
use astrix_utils::sim::{Environment, Process, Resumption, Suspension};
...
impl TemplateTransactionSelector for OnetimeTxSelector {
    ...
    fn reject_selection(&mut self, _tx_id: astrix_consensus_core::tx::TransactionId) {
        unimplemented!()
    }
    ...
    fn build_txs(&mut self) -> Vec<Transaction> {
        ...
        let txs = self
            ...
            .map(|mutable_tx| {
                ...
                let mass = self
                    .mass_calculator
                    .calc_tx_overall_mass(&signed_tx.as_verifiable(), None, astrix_consensus::processes::mass::Kip9Version::Alpha)
                    .unwrap();
