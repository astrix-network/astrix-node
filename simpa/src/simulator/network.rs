...
use astrix_consensus::config::Config;
...
use astrix_database::{create_permanent_db, create_temp_db};
use astrix_utils::fd_budget;
use astrix_utils::sim::Simulation;

type ConsensusWrapper = (Arc<Consensus>, Vec<JoinHandle<()>>, DbLifetime);

pub struct AstrixNetworkSimulator {
