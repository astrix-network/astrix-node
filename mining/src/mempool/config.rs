use astrix_consensus_core::constants::TX_VERSION;
...
// TODO: when astrix-node nodes run most of the network, consider increasing this value
...
impl Config {
    ...
    /// The arguments should be obtained from the current consensus [`astrix_consensus_core::config::params::Params`] instance.
