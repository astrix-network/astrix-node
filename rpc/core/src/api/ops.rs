...
pub enum RpcApiOps {
    ...
    GetSyncStatus,
    /// Returns the network this Astrixd is connected to (Mainnet, Testnet)
    GetCurrentNetwork,
    ...
    GetBlockTemplate,
    /// Returns a list of all the addresses (IP, port) this Astrixd knows and a list of all addresses that are currently banned by this Astrixd
    GetPeerAddresses,
    ...
    GetMempoolEntries,
    /// Returns a list of the peers currently connected to this Astrixd, along with some statistics on them
    GetConnectedPeerInfo,
    /// Instructs Astrixd to connect to a given IP address.
    AddPeer,
