...
use astrix_consensus_notify::notification as consensus_notify;
use astrix_index_core::notification as index_notify;
use std::sync::Arc;
...
impl From<&index_notify::UtxosChangedNotification> for UtxosChangedNotification {
    ...
    // Use astrix_rpc_service::converter::index::IndexConverter instead.
