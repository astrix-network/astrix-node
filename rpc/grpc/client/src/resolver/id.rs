use crate::{
    error::{Error, Result},
    resolver::{AstrixdResponseReceiver, AstrixdResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: AstrixdResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: AstrixdPayloadOps, request: &AstrixdRequest) -> AstrixdResponseReceiver {
