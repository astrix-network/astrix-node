use crate::protowire::{astrixd_request::Payload as RequestPayload, astrixd_response::Payload as ResponsePayload, *};
...
pub enum AstrixdPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into AstrixdPayloadOps fails.
}
}
