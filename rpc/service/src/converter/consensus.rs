...
use astrix_consensus_notify::notification::{self as consensus_notify, Notification as ConsensusNotification};
use astrix_consensusmanager::{ConsensusManager, ConsensusProxy};
use astrix_math::Uint256;
use astrix_mining::model::{owner_txs::OwnerTransactions, TransactionIdSet};
use astrix_notify::converter::Converter;
use astrix_rpc_core::{
...
use astrix_txscript::{extract_script_pub_key_address, script_class::ScriptClass};
...
impl ConsensusConverter {
    ...
    ///
    /// _GO-ASTRIXD: PopulateBlockWithVerboseData_
    ...
    ///
    /// _GO-ASTRIXD: PopulateTransactionWithVerboseData
